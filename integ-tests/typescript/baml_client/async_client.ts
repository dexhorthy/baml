...
export class BamlAsyncClient {
  ...
  <<<<<<<
  HEAD
  async InOutLiteralIntMapKey(
    i1: Partial<Record<1 | 2 | 3 | 4, string>>,
    i2: Partial<Record<1 | 2 | 3 | 4, string>>,
    __baml_options__?: { tb?: TypeBuilder; clientRegistry?: ClientRegistry },
    ...
    try {
      ...
      return raw.parsed() as Partial<Record<1 | 2 | 3 | 4, string>>
    } catch (error: any) {
      const bamlError = createBamlValidationError(error)
      if (bamlError instanceof BamlValidationError) {
        throw bamlError
  ...
  async InOutLiteralStringMapKey(
  =======
  ...
  >> {
    try {
      const
  raw = await this.runtime.callFunction(
<<<<<<< HEAD
...
catch (error: any)
{
  ...
  async LiteralUnionsTest(
      ...
      __baml_options__?:
{
  tb?: TypeBuilder, clientRegistry?: ClientRegistry
}
...
class BamlStreamClient {
  ...
  InOutLiteralIntMapKey(
    ...
    i2: Partial<Record<1 | 2 | 3 | 4, string>>,
    __baml_options__?: { tb?: TypeBuilder; clientRegistry?: ClientRegistry },
  ): BamlStream<RecursivePartialNull<Partial<Record<1 | 2 | 3 | 4, string>>>, Partial<Record<1 | 2 | 3 | 4, string>>> {
    try {
      const raw = this.runtime.streamFunction(
        'InOutLiteralIntMapKey',
        {
      ...
      return new BamlStream<
        RecursivePartialNull<Partial<Record<1 | 2 | 3 | 4, string>>>,
        Partial<Record<1 | 2 | 3 | 4, string>>
      >(
        raw,
        (a): a is RecursivePartialNull<Partial<Record<1 | 2 | 3 | 4, string>>> => a,
        (a): a is Partial<Record<1 | 2 | 3 | 4, string>> => a,
        this.ctx_manager.cloneContext(),
        __baml_options__?.tb?.__tb(),
      )
    } catch (error) {
  ...
  BamlStream<RecursivePartialNull<Partial<Record<"one" | "two" | "three" | "four", string>
  >>,
  Partial<Record<"one" | "two" | "three" | "four", string>
  >> {
    try {
      const
  raw = this.runtime.streamFunction(
    'InOutLiteralStringMapKey',
    {
      i1: i1,
      i2: i2,
